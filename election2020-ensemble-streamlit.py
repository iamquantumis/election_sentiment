...
# ---------------------------
def main():
    st.title("Twitter/X Sentiment Analysis for Two Election Candidates")
    ...
    st.write(
        ...
        on the tweets/X posts about each candidate?
        
        Use the sample data from 2020 US Elections or upload two CSV files—one per candidate. 
        The app merges tweets from both candidates, cleans them, and sends batches to the
        Hugging Face Inference API for sentiment analysis. Results are ensembled across the
